...
import { dependencyChart } from "./charts/LineChart1.js";
...
try {
    ...
    const rungeKuttaCloseResults = solveRungeKutta({ coefficients, init, step: step / 10, dot});
    
    dependencyChart(eulerResults, eulerModResults, rungeKuttaResults, rungeKuttaCloseResults);
